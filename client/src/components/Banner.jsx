        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-6">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold text-slate-100 tracking-tight leading-tight">
              Turn Your Luxury Car Into <span className="text-transparent bg-clip-text bg-linear-to-r from-amber-200 via-amber-400 to-amber-500">Revenue</span>
            </h2>
            
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed">
              Monetize your vehicle effortlessly by listing it on Firefly Car Rental.
            </p>
            
            <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
              We handle comprehensive insurance, secure payments, and verified drivers—so you earn passive income completely stress-free.
            </p>
            
            
            <button className="bg-linear-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 font-semibold px-8 py-3.5 rounded-xl shadow-lg shadow-amber-500/10 transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer">
              List Your Car
            </button>
          </div>
