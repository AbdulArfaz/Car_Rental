  ...
  const dashboardCards = [
    {
      ...
      cardBg:
        "bg-linear-to-tr from-[#E0F7FA] via-[#B2EBF2] to-[#80DEEA] text-slate-900 border-cyan-300",
    ...
    },
    {
      ...
      cardBg:
        "bg-linear-to-tr from-[#E1F5FE] via-[#B3E5FC] to-[#81D4FA] text-slate-900 border-sky-300",
    ...
    },
    {
      ...
      cardBg:
        "bg-linear-to-tr from-[#E0F2FE] via-[#BAE6FD] to-[#7DD3FC] text-slate-900 border-blue-300",
    ...
    },
    {
      ...
      cardBg:
        "bg-linear-to-tr from-[#F0F9FF] via-[#E0F2FE] to-[#BAE6FD] text-slate-900 border-sky-300",
      iconBg: "bg-sky-200/60 border border-sky-300 shadow-sm",
    },
  ];
    ...
    <div className="space-y-6 pb-10">
      <div className="mb-2">
        ...
        <p className="text-sm text-slate-400 mt-1">
          Your centralized hub for monitoring cars, customer bookings, real-time
          revenue streams, and recent activity in one place.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {dashboardCards.map((card, index) => (
          ...
          >
            ...
            <div
              className={`w-12 h-12 rounded-xl ${card.icon} flex items-center justify-center p-2.5 shadow-lg`}
            >
              <img
                src={card.icon}
                alt="card"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div className="bg-linear-to-tr from-[#E1F5FE] via-[#B3E5FC] to-[#81D4FA] border border-sky-300 rounded-2xl p-6 shadow-xl flex flex-col justify-between text-slate-900">
          <div>
            ...
            <p className="text-xs text-sky-950 opacity-90">
